...
@function
def computefirstChristoffelsymbol3D(N=None,deltaq=None,covariantbase=None,firstdevneighbours=None,*args,**kwargs):
    varargin = computefirstChristoffelsymbol3D.varargin
    nargin = computefirstChristoffelsymbol3D.nargin
