...
@function
def computeRiccitensor3Dsurface(Riemanntensor=None,reciprocalmetriccoefficients=None,*args,**kwargs):
    varargin = computeRiccitensor3Dsurface.varargin
    nargin = computeRiccitensor3Dsurface.nargin
...
#R2212 = Riemanntensor(:,14);
    ...
    # R_ij = R_ji
    R11=multiply(G11,R1111) + multiply(G12,R1112) + multiply(G21,R1211) + multiply(G22,R1212)
    R12=multiply(G11,R1121) + multiply(G12,R1122) + multiply(G21,R1221) + multiply(G22,R1222)
    R22=multiply(G11,R2121) + multiply(G12,R2122) + multiply(G21,R2221) + multiply(G22,R2222)
